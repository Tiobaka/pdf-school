...
def main():
    ...
    if args.adaptive:
        from pdf_school.bridges.study_db import get_weakness_queue
        ...
        from pdf_school.engine.scheduler import generate_daily_schedule
    ...
    if args.tui:
        from pdf_school.tui.app import TutorTUIApp
